...
class VENTANA(Frame):
    ...
    def fEliminar (self):
        ...
        clave = self.grid.item(selected, 'text')    
        if clave == '':
            messagebox.showwarning("ELIMINAR",'HACER CLICK EN LA PROPIEDAD A ELIMINAR')
        else:
            valores =self.grid.item(selected,'values')
    ...
    def create_widgets(self):
        ...
        self.btnNuevo=Button(frame1,text="INGRESAR PROPIEDAD", command=self.fNuevo, bg="green",fg="white")
        self.btnNuevo.place(x=5,y=50,width=150,height=30)

        self.btnModificar=Button(frame1,text="MODIFICAR PROPIEDAD", command=self.fModificar, bg="green",
        fg="white")
        self.btnModificar.place(x=5,y=90,width=150,height=30)

        self.btnEliminar=Button(frame1,text="ELIMINAR PROPIEDAD", command=self.fEliminar, bg="green",
        fg="white")
        self.btnEliminar.place(x=5,y=130,width=150,height=30)

        self.btnlistatotal=Button(frame1,text="VER TOTAL DE PROP.", command=self.fListatotal, bg="blue",
        fg="black")
        self.btnlistatotal.place(x=5,y=200,width=150,height=30)

        self.btndventa=Button(frame1,text="DISPONIBLES P-VENTA", command=self.fDventa, bg="blue",fg="black")
        self.btndventa.place(x=5,y=240,width=150,height=30)

        self.btndalq=Button(frame1,text="DISP. P-ALQUILER", command=self.fDalq, bg="blue",fg="black")
        self.btndalq.place(x=5,y=280,width=150,height=30)

        self.btnvendidas=Button(frame1,text="PROP. VENDIDAS", command=self.fVen, bg="blue",fg="black")
        self.btnvendidas.place(x=5,y=320,width=150,height=30)

        self.btnalqui=Button(frame1,text="PROP. ALQUILADAS", command=self.fAlq, bg="blue",fg="black")
        ...
        lbl3=Label(frame2,text="Id_Operatoria_Comercial")
        ...
        self.txtdir.place(x=3,y=225,width=190,height=20)

        lbl6=Label(frame2,text="Localidad")
        lbl6.place(x=3,y=255)
        self.txtlocalidad=Entry(frame2)
        self.txtlocalidad.place(x=3,y=275,width=190,height=20)
        
        lbl7=Label(frame2,text="Provincia")
        lbl7.place(x=3,y=305)
        self.txtprovincia=Entry(frame2)
        self.txtprovincia.place(x=3,y=325,width=190,height=20)
